...
project = u'slext'
copyright = u'2018, tomasz.kurgan@gmail.com'
author = u'tomasz.kurgan@gmail.com'
...
extensions = [
    ...
    'sphinx.ext.viewcode',
    'sphinx.ext.napoleon',
    'm2r',  # support for markdown documents
]
...
latex_documents = [
    (master_doc, 'slext.tex', u'slext Documentation',
     u'tomasz.kurgan@gmail.com', 'manual'),
]
...
man_pages = [
    (master_doc, 'slext', u'slext Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'slext', u'slext Documentation',
     author, 'slext', 'One line description of project.',
     'Miscellaneous'),
]
...
# -- External theme modification _--------------------------------------------
from sphinx_theme import main
main.init()
